...
public class SignInFinishLimitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_finish_limit_time);
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Toast.makeText(SignInFinishLimitActivity.this, member.getMemberName(), Toast.LENGTH_SHORT).show();
        });
        ...
        finishSignInBtn.setOnClickListener(v -> {
            ...
            OkHttpUtil.getInstance().PostWithJsonToken(UrlConfig.getUrl(UrlConfig.UrlType.STOP_SIGN_IN) + signId, new JSONObject(), new Callback() {
                ...
                public void onFailure(@NotNull Call call, @NotNull IOException e) {
                    ...
                    AlertDialogUtil.showConfirmClickAlertDialog("结束签到错误" + e.getMessage(), SignInFinishLimitActivity.this);
                }
            ...
            AlertDialogUtil.showConfirmClickAlertDialog("结束签到", SignInFinishLimitActivity.this);
        });
    }
    ...
    public void initMember(final boolean isRe) {
        if (isRe) {
            progressDialog = new ProgressDialog(SignInFinishLimitActivity.this);
        ...
        OkHttpUtil.getInstance().GetWithToken(UrlConfig.getUrl(UrlConfig.UrlType.GET_SIGNIN_ALL_STUDENT_INFO) + signId, new Callback() {
            @Override
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                AlertDialogUtil.showToastText(e.getMessage(), SignInFinishLimitActivity.this);
            }
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) {
                try {
                    ...
                    runOnUiThread(
                            () -> {
                                signIngMemberAdapter = new SignIngMemberAdapter(SignInFinishLimitActivity.this, R.layout.item_member, memberList);
    ...
    public void parseJoinedList(String JsonArrayData) {
        ...
        if (jsonArray == null || jsonArray.size() == 0) {
            AlertDialogUtil.showToastText("暂时没有人签到", SignInFinishLimitActivity.this);
        }
        memberList.clear();
        int num = 1;
